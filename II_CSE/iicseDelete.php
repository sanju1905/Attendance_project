        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3><b>Delete the II-CSE </b><a href="./iicsefetchdata.php">
                        <br> <button class="btn btn-warning float-end">Back</button></a></h3>
                   
                </div>
                <div class="card-body">
                    <form action="iicsedeletecode.php" method="POST">
                        <!-- slider ends 
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" name="deleteii_data" class="btn btn-primary">Delete Data</button>
                        </div>
                    </form>
                </div>
            </div>
