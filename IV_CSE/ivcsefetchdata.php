...
<body>
    <div class="container pt-5px">
        ...
        <div class="jumbotron">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h2>Absenties Data of IV-CSE </h2>
                </div>
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit" name="filter_btn">Search</button>
               ...
               <span class="pl-5"> <div class="col-md-6">
                    <a href="../login.php" class="btn btn-secondary" style="margin-left: 80%;">HOME </a>    
                </div>
                <div class="col-md-12">
                    <hr>
                </div>
                    ...
                    <table class="table table-bordered" style="background-color: white;">
                        ...
                        <?php
                           ...
                           if(isset($_POST['filter_btn']))
                           {
                            ...
                            $query_search="SELECT * FROM ivcse WHERE CONCAT(absent,date) LIKE '%$value_filter%' ";
                            ...
                            while($row = mysqli_fetch_array($query_run))
                            {
                                ?>
                                    <tr>
                                        ...
                                        <th> <?php echo $row['subject']; ?> </th>
                                        <th> <?php echo $row['absent']; ?> </th>
                                        <th><a href="ivcse.php" class="btn btn-success"> ADD   </a> </th>         
                                        <th><a href="ivcseupdate.php" class="btn btn-primary" > UPDATE </a> </th>
                                        <th><a href="ivcseDelete.php" class="btn btn-danger" > DELETE </a> </th>
