        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3><b>Delete the IV-CSE </b><a href="./ivcsefetchdata.php">
                        <br> <button class="btn btn-warning float-end">Back</button></a></h3>
                   
                </div>
                <div class="card-body">
                    <form action="ivcsedeletecode.php" method="POST">
                        <!-- slider ends 
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" name="deleteiv_data" class="btn btn-primary">Delete Data</button>
                        </div>
                    </form>
                </div>
            </div>
