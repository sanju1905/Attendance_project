...
<body>
    <div class="container pt-5px">
        ...
        <div class="jumbotron">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h2>Absenties Data of III-CSE </h2>
                </div>
                    ...
                    <table class="table table-bordered" style="background-color: white;">
                        ...
                        <?php
                           ...
                           if(isset($_POST['filter_btn']))
                           {
                            ...
                            $query_search="SELECT * FROM iiicse WHERE CONCAT(absent,date) LIKE '%$value_filter%' ";
                            ...
                            while($row = mysqli_fetch_array($query_run))
                            {
                                ?>
                                    <tr>
                                        ...
                                        <th> <?php echo $row['subject']; ?> </th>
                                        <th> <?php echo $row['absent']; ?> </th>
                                        <th><a href="iiicse.php" class="btn btn-success"> ADD   </a> </th>         
                                        <th><a href="iiicseupdate.php" class="btn btn-primary" > UPDATE </a> </th>
                                        <th><a href="iiicseDelete.php" class="btn btn-danger" > DELETE </a> </th>
