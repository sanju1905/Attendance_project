        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <br>
                    <h3><b>Insert Attendance of III CSE</b><a href="../login.php"> <br><br><button class="btn btn-warning float-end">Back</button></a></h3>
                   
                </div>
                <div class="card-body">
                    <form action="iiicseUpdatecode.php" method="POST">
